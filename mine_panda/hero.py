...
class Hero():
    ...
    def accept_events(self):
        ...
        base.accept(key_upcam, self.camUp)
        base.accept(key_upcam + '-repeat', self.camUp)
        base.accept(key_downcam, self.camDown)
        base.accept(key_downcam + '-repeat', self.camDown)